...
# the following need to be installed with pip: tqdm, tiktoken, pyarrow, aiohttp, apache_beam, datasets
...
if __name__ == '__main__':
    ...
    # owt by default only contains the 'train' split, so create a test split
    split_dataset = dataset["train"].train_test_split(test_size=0.005, seed=12345, shuffle=True)
    split_dataset['val'] = split_dataset.pop('test') # rename the test split to val
